...
Command: `npm test` (`node --test`). Current count: 40 tests in `test/settings.test.js`.
...
| M-02 | Permission denied | Error is useful; note current Windows-specific wording gap |
