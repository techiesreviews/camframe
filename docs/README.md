...
2. [`product-spec.md`](product-spec.md) — the user-visible v0.4.3 product contract.
...
- Settings schema: `11`
- Documentation audit date: `2026-08-28`
- Audit scope: all tracked source, tests, package/build metadata, workflow files, ADRs, first-parent history, merged PR descriptions, and GitHub issue 5.
